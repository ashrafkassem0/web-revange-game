...
## Objective
Build a comprehensive settings screen accessible from main menu and in-game pause menu, using HTML/CSS for the menu overlay (not Pixi.js).
...
- HTML/CSS overlay (not Pixi.js) — simpler for form elements
...
- [ ] Zoom slider updates Pixi.js camera zoom
